...
\begin{algorithm}[H]
	...
	\label{alg:ddpg}
\end{algorithm}
\textbf{Ornstein-Uhlenbeck Process}: It is continious analogue of discrete AR(1) process \cite{uhlenbeck_theory_1930}. The process $x$ is defined by a stochastic differential equation \eqref{eqn:ou_process}
\begin{equation}
