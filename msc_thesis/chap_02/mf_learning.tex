...
SAC is an entropy regularized RL method. Such methods give bonus reward to the agent propotional to the policy entropy. Given state $s$, entropy of a policy is defined as,
\begin{equation}
