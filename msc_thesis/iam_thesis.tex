...
%
\date{June 2021} % do NOT use comma
%
...
\keywords{deep reinforcement learning, partial observability, robot control, actor-critic methods}
\anahtarklm{pekiştirmeli derin öğrenme, kısmi gözlemlenebilirlik, robot kontrolü, aktör-eleştirmen metodları}
...
\input{abstract} % filename: abstract.tex
}
%
% Turkish Abstract
%
...
\input{oz} % filename: oz.tex
} 
%
% Dedication 
\dedication{\textit{ For anyone who made me able to write this thesis. % better to write here as it is short enough
}}
%
%
% Acknowledgements   
...
\input{acknowledgments} % filename: acknowledgments.tex
}
%
...
\input{myDefinitions} % filename: myDefinitions.tex
...
\input{abbreviations} % filename: abbreviations.tex
...
\input{chap_01/intro}
\input{chap_01/problem_statement}
\input{chap_01/proposed_methods}
\input{chap_01/related_work}
\input{chap_01/outline}
\input{chap_02/intro}
\input{chap_02/rl_opt_control}
\input{chap_02/chal}
\input{chap_02/decision_making}
\input{chap_02/mdp}
\input{chap_02/pomdp}
\input{chap_02/policy_control}
\input{chap_02/mf_learning}
\input{chap_03/intro}
\input{chap_03/backprop}
\input{chap_03/units}
\input{chap_03/nnets}
\input{chap_04/intro}
\input{chap_04/proposed_networks}
\input{chap_04/rlmethod}
\input{chap_04/results}
\input{chap_04/discussion}
\input{chap_05/conclusion}
\input{chap_05/future_work}
