...
\title{Reinforcement Learning methods for Bipedal Robot Walking in Partially Observed Environment}
...
\director[prof]{Bülent Karasözen}
% Head of Department
\headofdept[prof]{Ömür Uğur}
%
...
\anahtarklm{pekiştirmeli derin öğrenme, kısmi gözlemlenebilirlik, robot kontrolü, aktör-eleştirmen metodları, vs.}
...
%
% Dedication 
\dedication{\textit{ % better to write here as it is short enough
}}
%
%
% Acknowledgements   
...
\input{chap_01/intro}
\input{chap_01/sec_01}
\input{chap_01/sec_02}
\input{chap_01/sec_03}
\input{chap_01/sec_04}
\input{chap_02/intro}
\input{chap_02/rl_opt_control}
\input{chap_02/ml}
\input{chap_02/mdp}
\input{chap_02/mb_learning}
\input{chap_02/mf_learning}
\input{chap_03/intro}
\input{chap_03/nnets}
\input{chap_04/intro}
\input{chap_04/algs}
\input{chap_04/evaluation}
\input{chap_05/intro}
\input{chap_06/intro}
