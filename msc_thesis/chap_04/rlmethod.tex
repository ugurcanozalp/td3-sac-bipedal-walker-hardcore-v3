...
All hyperparameters are found after a trial-error process considering literature. They  are summarized in \tabref{table:hyperparams_td3} and \tabref{table:hyperparams_sac}. 
