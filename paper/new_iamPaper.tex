...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{figures/bipedal/STD_TD3_RFFNN_LSTM-6_TRSF-6.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{figures/bipedal/STD_SAC_RFFNN_LSTM-6_TRSF-6_LSTM-12_TRSF-12.png}
