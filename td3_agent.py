...
class TD3Agent():
    ...
    def __init__(self, Actor, Critic, clip_low, clip_high, state_size=24, action_size=4, update_freq=int(4),
            lr=4e-4, weight_decay=1e-4, gamma=0.99, tau=0.005, batch_size=128, buffer_size=int(2e5)):
        ...
        self.noise_generator = OrnsteinUhlenbeckNoise(mu=np.zeros(action_size), theta=0.15, sigma=0.2) # theta=0.15, sigma=0.17
