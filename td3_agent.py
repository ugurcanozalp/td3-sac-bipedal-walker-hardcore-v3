...
class TD3Agent():
    ...
    def __init__(self, Actor, Critic, clip_low, clip_high, state_size=24, action_size=4, update_freq=int(2),
            lr=1e-3, weight_decay=1e-5, gamma=0.99, tau=0.005, batch_size=128, buffer_size=int(1e6)):
        ...
        self.actor_optim = optim.AdamW(self.train_actor.parameters(), lr=0.25*lr, weight_decay=weight_decay) 
        ...
        self.noise_generator = OrnsteinUhlenbeckNoise(mu=np.zeros(action_size), theta=1.2, sigma=0.2, dt=0.02)
