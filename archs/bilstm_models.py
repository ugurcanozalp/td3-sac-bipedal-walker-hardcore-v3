...
class NormalizedLSTM(nn.Module):
    def __init__(self, input_size, hidden_size=96, batch_first=True, dropout=0.1):
        ...
        self.lstm.bias_hh_l0_reverse.data.fill_(-3.0) # force lstm to output to depend on only last state at the initialization.
...
class Critic(nn.Module):
    ...
    def __init__(self, state_dim=24, action_dim=4):
        ...
        self.fc2 = nn.Linear(64 + self.action_dim, 128)
