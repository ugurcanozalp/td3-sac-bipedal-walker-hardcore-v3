...
\begin{itemize}
	...
	\item Performance of sequential models on partially observable environments
...
Unlike other learning paradigms, a RL agent must;
\begin{itemize}
...
\begin{itemize}
	...
	\item Using observation history improved performance since environment is partially observable.
